...
export function Header() {
  return (
    <div
      className={cn(
        "sticky top-0 z-50 bg-card/95 backdrop-blur-sm shadow-sm border-b",
        "py-2 px-4" 
      )}
    >
      <header 
        className="container mx-auto flex items-center justify-between h-12" // Added fixed height for better alignment
      >
